          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, employees.id AS empid FROM employees LEFT JOIN company ON company.id=employees.company_id LEFT JOIN schedules ON schedules.id=employees.schedule_id";
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#company_val').val(response.company_id).html(response.description);
